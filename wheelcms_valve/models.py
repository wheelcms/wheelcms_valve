...
from wheelcms_spokes.page import PageBase, PageType
...
class ValveBlogType(PageType):
    model = ValveBlog
    title = "A Valve blog"
    children = (FileType, ImageType, ValveEntryType)
    ...
    def context(self, handler, request, node):
        ...
        ctx['paginator'] = paginator = SectionedPaginator(self.instance.node.children(), 4)
